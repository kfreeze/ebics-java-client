...
public class EbicsXmlFactory {
     ...
     */
    public static ProductElementType createProductElementType(String language, String product, String instituteId) {
        ...
        if (instituteId != null) {
            newProductElementType.setInstituteID(instituteId);
        }
     ...
     */
    public static StaticHeaderOrderDetailsType createStaticHeaderOrderDetailsType(String orderId, StaticHeaderOrderDetailsType.AdminOrderType adminOrderType,
     ...
     */
    public static Product createProduct(String language, String value, String instituteId) {
        Product newProduct = Product.Factory.newInstance();
        newProduct.setLanguage(language);
        newProduct.setStringValue(value);
        if (instituteId != null) {
            newProduct.setInstituteID(instituteId);
        }
